  ...
  return (
    <div className="card shadow-sm border-0 h-100" style={{ background: 'var(--tblr-primary-lt)' }}>
      <div className="card-header border-0 pb-0 pt-4 px-4 bg-transparent">
        <h3 className="card-title fw-bold">Portfolio Health</h3>
        <div className="card-actions">
          <div className="dropdown">
            ...
            >
              <span className="text-decoration-underline-hover">Optimized</span>
      ...
      <div className="card-body p-4 pt-3">
        <div className="d-flex justify-content-between align-items-end mb-3">
          <div>
            <div className="text-secondary small fw-medium mb-1">Health Status</div>
            <div className="h1 fw-bold mb-0 lh-1 text-primary" style={{ fontSize: '1.8rem' }}>
              Optimized
            </div>
          </div>
          <div className="h1 fw-bold mb-0 lh-1 text-primary" style={{ fontSize: '2rem', letterSpacing: '-0.5px' }}>High</div>
        </div>
