      ...
      <div className="card-body p-3 p-lg-4">
        <div className="d-flex align-items-center gap-2 mb-3">
          <div 
            ...
            style={{ borderRadius: '10px', width: '32px', height: '32px', backgroundColor: activeColor }}
          >
        ...
        <div className={clsx('h1 mb-1 fw-bold lh-1 text-nowrap', textClass)} style={{ letterSpacing: '-0.5px' }}>
          {value}
        </div>
        <div className="text-muted small" style={{ fontSize: '11px' }}>{subtext}</div>
      </div>
    </div>
  );
}
