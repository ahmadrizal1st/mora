      ...
      <div className="card-body p-4">
        <div className="text-center">
          ...
          >
            ...
            >
              <div
                className="display-3 fw-bold lh-1"
                style={{
                  color: activeColor,
            ...
            <div
              className="d-flex justify-content-between px-4 position-absolute w-100"
              style={{ bottom: '40%' }}
            >
          ...
          <div className="text-secondary opacity-50 mb-1" style={{ fontSize: '10px' }}>
            VantageScore 3.0 from Banking App
          </div>
