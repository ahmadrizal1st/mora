...
export function Budget503020Card() {
  ...
  // Calculate spent per budget type dynamically
  ...
  // Radial configurations: radius, stroke width, color, percentage
  const rings = [
    {
      id: 'needs',
      name: 'Kebutuhan',
    ...
    <div className="card shadow-sm border-0 h-100 w-100" style={{ borderRadius: '24px' }}>
      <div className="card-body p-4 d-flex flex-column align-items-center justify-content-between">
        ...
        <div className="position-relative my-1 d-flex align-items-center justify-content-center w-100">
          ...
          <svg className="concentric-chart-svg" viewBox={`0 0 ${size} ${size}`}>
            ...
            {rings.map((ring) => {
              ...
              // Angle for dot positioning: starts at 9 o'clock (180 degrees)
              ...
              return (
                <g key={ring.id}>
                  ...
                  />
                  {/* Knob/Dot at the end of the arc */}
                  <circle
                    cx={dotX}
                    cy={dotY}
                    r={7.5}
                    ...
                    filter="url(#shadow)"
                    style={{
                      transition: 'cx 1.2s cubic-bezier(0.4, 0, 0.2, 1), cy 1.2s cubic-bezier(0.4, 0, 0.2, 1)',
                    }}
                  />
                </g>
              );
        ...
        <div className="text-center w-100 mt-1 mb-2">
          <div className="text-secondary small fw-bold text-uppercase mb-0" style={{ fontSize: '9px', letterSpacing: '0.8px' }}>
            BUDGET BULANAN
          </div>
          <h2 className="fw-bold text-body mb-0" style={{ fontSize: '1.6rem', letterSpacing: '-0.5px' }}>
        ...
        <div className="w-100 d-flex flex-column gap-2">
          ...
          <div className="d-flex flex-column">
            <div className="d-flex align-items-center justify-content-between mb-1">
              <div className="d-flex align-items-center gap-2">
                <div style={{ width: '12px', height: '12px', borderRadius: '50%', backgroundColor: '#ff6b00' }} />
                <span className="fw-bold text-body" style={{ fontSize: '13px' }}>Kebutuhan</span>
              </div>
              <span 
            ...
            <div className="d-flex align-items-center justify-content-between gap-3">
              <div className="flex-fill bg-light rounded-pill" style={{ height: '5px', backgroundColor: '#e9ecef', overflow: 'hidden' }}>
                <div 
              ...
              <span className="text-muted small text-nowrap" style={{ fontSize: '10px' }}>50% target</span>
            </div>
          </div>
          ...
          <div className="d-flex flex-column">
            <div className="d-flex align-items-center justify-content-between mb-1">
              <div className="d-flex align-items-center gap-2">
                <div style={{ width: '12px', height: '12px', borderRadius: '50%', backgroundColor: '#066fd1' }} />
                <span className="fw-bold text-body" style={{ fontSize: '13px' }}>Keinginan</span>
              </div>
              <span 
                className="badge fw-bold" 
                style={{ 
            ...
            <div className="d-flex align-items-center justify-content-between gap-3">
              ...
              <span className="text-muted small text-nowrap" style={{ fontSize: '10px' }}>30% target</span>
            </div>
          </div>
          ...
          <div className="d-flex flex-column">
            <div className="d-flex align-items-center justify-content-between mb-1">
              <div className="d-flex align-items-center gap-2">
                <div style={{ width: '12px', height: '12px', borderRadius: '50%', backgroundColor: '#2fb344' }} />
                <span className="fw-bold text-body" style={{ fontSize: '13px' }}>Tabungan</span>
              </div>
              <span 
                className="badge fw-bold" 
                style={{ 
            ...
            <div className="d-flex align-items-center justify-content-between gap-3">
              ...
              <span className="text-muted small text-nowrap" style={{ fontSize: '10px' }}>20% target</span>
            </div>
          </div>
        </div>
