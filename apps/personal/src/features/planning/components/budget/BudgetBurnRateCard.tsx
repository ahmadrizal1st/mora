...
export function BudgetBurnRateCard({ spent, totalBudget }: BudgetBurnRateCardProps) {
  ...
  return (
    <div className="card shadow-sm border-0 h-100 w-100" style={{ borderRadius: '16px', background: 'var(--tblr-bg-surface)' }}>
      <div className="card-body p-4 d-flex flex-column justify-content-center gap-3">
        <div>
          ...
          <div className="mb-3">
            ...
            <div className="progress progress-xs mt-2" style={{ height: '6px', background: 'var(--tblr-border-color)' }}>
              <div 
          ...
          <div className="p-3 rounded-3 bg-surface border border-secondary-subtle shadow-sm mb-3">
            <div className="row g-2">
              <div className="col-6 border-end">
                ...
                <div className={`fw-bold ${isOverBudget ? 'text-danger' : 'text-body'}`}>{formatCurrency(projectedSpent)}</div>
