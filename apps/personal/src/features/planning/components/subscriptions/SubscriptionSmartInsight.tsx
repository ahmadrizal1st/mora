      ...
      <Modal show={isOpen} onClose={() => setIsOpen(false)} size="lg">
        ...
        <div className="modal-body p-4">
          <p className="text-secondary mb-4">
            Berdasarkan analisis riwayat transaksi dan aktivitas Anda, berikut adalah beberapa cara untuk mengoptimalkan pengeluaran langganan bulanan Anda:
          </p>
          <div className="d-flex flex-column gap-3 text-body">
            ...
            <div className="p-3 bg-body-tertiary rounded-3 border-0 d-flex justify-content-between align-items-center">
              <div className="d-flex align-items-center gap-3">
                <div className="p-2 bg-orange-lt text-orange rounded-circle d-flex align-items-center justify-content-center" style={{ width: '40px', height: '40px' }}>
                  <Icon icon="brand-netflix" size="sm" />
                </div>
                <div>
                  <h4 className="fw-bold mb-1">Gabungkan Akun Netflix</h4>
                  <p className="small text-secondary mb-0">Bagikan paket Family dengan anggota keluarga.</p>
                </div>
              </div>
              <div className="text-end">
                <span className="badge bg-success-lt text-success border-0 px-2 py-1 mb-1" style={{ fontSize: '10px' }}>Hemat Rp 45.000/bln</span>
                <div><button className="btn btn-outline-primary btn-sm rounded-pill px-3 py-1" style={{ fontSize: '11px' }}>Terapkan</button></div>
              </div>
            </div>
            ...
            <div className="p-3 bg-body-tertiary rounded-3 border-0 d-flex justify-content-between align-items-center">
              <div className="d-flex align-items-center gap-3">
                ...
                <div>
                  ...
                  <p className="small text-secondary mb-0">Tidak terdeteksi pemakaian dalam 90 hari terakhir.</p>
                </div>
              </div>
              <div className="text-end">
                <span className="badge bg-danger-lt text-danger border-0 px-2 py-1 mb-1" style={{ fontSize: '10px' }}>Hemat Rp 39.000/bln</span>
                <div><button className="btn btn-outline-danger btn-sm rounded-pill px-3 py-1" style={{ fontSize: '11px' }}>Batalkan</button></div>
              </div>
            </div>
            ...
            <div className="p-3 bg-body-tertiary rounded-3 border-0 d-flex justify-content-between align-items-center">
              <div className="d-flex align-items-center gap-3">
                ...
                <div>
                  ...
                  <p className="small text-secondary mb-0">Bayar tahunan untuk mendapatkan diskon hingga 16%.</p>
                </div>
              </div>
              <div className="text-end">
                <span className="badge bg-success-lt text-success border-0 px-2 py-1 mb-1" style={{ fontSize: '10px' }}>Hemat Rp 120.000/thn</span>
                <div><button className="btn btn-outline-primary btn-sm rounded-pill px-3 py-1" style={{ fontSize: '11px' }}>Beralih</button></div>
              </div>
            </div>
          </div>
        </div>
