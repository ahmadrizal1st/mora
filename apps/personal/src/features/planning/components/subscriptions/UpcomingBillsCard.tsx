    ...
    <div className="card border-0 shadow-sm h-100" style={{ borderRadius: '16px' }}>
      <div className="card-body p-4 d-flex flex-column">
        <div className="d-flex justify-content-between align-items-start mb-3">
          <div>
            <div className="text-secondary small fw-bold text-uppercase mb-1" style={{ fontSize: '10px', letterSpacing: '0.05em' }}>Total Tagihan</div>
            <div className="h2 fw-bold mb-0">{formatCurrency(totalMonthly)}</div>
          </div>
          <div className="p-2 rounded-circle shadow-sm" style={{ backgroundColor: 'var(--tblr-primary)', color: '#fff' }}>
        ...
        <div className="d-flex justify-content-between align-items-center mb-4">
          <div>
            <div className="text-secondary small fw-medium" style={{ fontSize: '10px' }}>Sudah Dibayar</div>
        ...
        {/* Detailed Upcoming List to Balance Height */}
