      ...
      <div className="card-body p-4">
        <div className="d-flex align-items-center justify-content-between mb-4">
          <div className="d-flex align-items-center gap-3">
            <div className="p-2 bg-orange-lt rounded-circle d-flex align-items-center justify-content-center" style={{ width: '40px', height: '40px' }}>
          ...
          <span className="badge bg-orange text-white fw-bold border-0 rounded-pill px-3 py-2" style={{ fontSize: '11px' }}>
            {percentage}%
          </span>
        </div>
        ...
        <div className="p-3 bg-light rounded-3 border-0 position-relative overflow-hidden">
          ...
          <div className="d-flex gap-3 align-items-center position-relative" style={{ zIndex: 1 }}>
            <div className="p-2 bg-orange text-white rounded-circle d-flex align-items-center justify-content-center shadow-none" style={{ width: '32px', height: '32px' }}>
              <Icon icon="bulb" size="sm" stroke={2.5} />
            </div>
            <p className="small text-secondary mb-0 fw-medium" style={{ fontSize: '11px', lineHeight: '1.6' }}>
              Dana darurat idealnya mencakup <strong>6 bulan</strong> biaya hidup. Tingkatkan setoran untuk keamanan finansial yang lebih baik.
            </p>
          </div>
        </div>
      </div>
