...
export function GoalCard({ goal, onClick }: GoalCardProps) {
  ...
  return (
    <div className="card border-0 transition-all overflow-hidden h-100 hover-scale-up" 
      ...
      {/* Content Overlay */}
      <div className="card-body p-4 d-flex flex-column justify-content-between position-relative h-100" style={{ zIndex: 2 }}>
        ...
        <div className="text-white">
          ...
          <div className="d-flex align-items-baseline gap-2 mb-3">
            ...
            <span className="small opacity-75" style={{ fontSize: '11px' }}>/ {formatCurrency(goal.target)}</span>
          </div>
          ...
          <div className="progress-container">
            ...
            <div className="progress overflow-visible" style={{ height: '6px', backgroundColor: 'rgba(255,255,255,0.2)', borderRadius: '10px' }}>
              <div 
