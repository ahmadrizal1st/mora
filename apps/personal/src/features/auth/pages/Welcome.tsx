...
export default function Welcome() {
  return (
    <div
      className="page page-center bg-surface d-flex flex-column"
    ...
    >
      ...
      <div
        className="container-tight d-flex flex-column align-items-center justify-content-between py-6 px-4 welcome-page-content"
      ...
      >
        ...
        <div className="w-100 text-center mb-4">
          <p
            className="text-body fs-3 mb-5 fw-bold px-2"
            style={{ maxWidth: '340px', margin: '0 auto', opacity: 0.9 }}
          >
            Your Intelligent AI Assistant for Modern Financial Success.
          </p>

          <div className="d-grid gap-3">
            <Button text="Sign In" color="primary" block className="fw-bold" to="/sign-in" />

            <Button text="Create Account" outline block className="text-body" to="/sign-up" />
          </div>
        </div>
      </div>
    </div>
