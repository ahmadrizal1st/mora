      ...
      <div className="card border-0 shadow-sm rounded-4">
        <div className="card-body p-4">
          <div className="text-center py-5 d-flex flex-column justify-content-center align-items-center flex-grow-1">
            <Icon icon="building-bank" size={32} stroke={1.5} className="text-secondary opacity-50 mb-3" />
            <div className="fw-bold text-body mb-1" style={{ fontSize: '14px' }}>Belum Ada Pinjaman KTA</div>
            <div className="text-secondary mb-3" style={{ fontSize: '12px', lineHeight: '1.5' }}>Tambahkan profil pinjaman Anda melalui menu "Tambah Profil" di atas.</div>
            <Button size="sm" color="primary" onClick={() => openFormForType('kta')}>
              ...
              <div className="d-flex justify-content-between gap-2 mb-3">
                <div className="col-6">
                  <div className="p-2 rounded-3 text-center" style={{ backgroundColor: '#f8fafc', border: '1px solid rgba(0,0,0,0.04)' }}>
                    <Icon icon="calendar-due" size={16} className="text-primary mb-1" />
                    <div className="text-secondary" style={{ fontSize: '10px', fontWeight: 600 }}>ANGSURAN KE</div>
                    <div className="fw-bold text-dark small">12 dari {credit.tenor_months}</div>
                  </div>
                </div>
                <div className="col-6">
                  <div className="p-2 rounded-3 text-center" style={{ backgroundColor: '#f8fafc', border: '1px solid rgba(0,0,0,0.04)' }}>
        ...
        <div className="card border-0 shadow-sm overflow-hidden credit-kta-card">
            ...
            <div className="card-body p-0 d-flex flex-column">
              <div className="d-flex justify-content-between align-items-center px-4 py-2 border-bottom flex-shrink-0">
                ...
                <span className="text-secondary" style={{ fontSize: '13px' }}>12 item</span>
              </div>
            ...
            <div className="card-footer d-flex flex-column flex-md-row align-items-center justify-content-between bg-transparent border-top py-2 gap-3">
              <div className="text-secondary small d-flex align-items-center">
                ...
                <strong>6</strong>&nbsp;dari&nbsp;<strong>12</strong>
                &nbsp;data
              </div>
