              ...
              <div>
                {[...Array(6)].map((_, i) => (
                  <div 
                    ...
                    style={{ borderBottom: i < 5 ? '1px solid #fafafa' : undefined }}
                  >
                    <div className="flex-grow-1 overflow-hidden me-2">
                      ...
                      <div className="d-flex align-items-center gap-1 flex-wrap mt-1" style={{ fontSize: '11px', color: '#a0aec0' }}>
                        <span className="rounded px-1 fw-semibold" style={{ background: '#f6ad5522', color: '#dd6b20', fontSize: '10px' }}>
                          Terjadwal
                        </span>
                        <span>&middot; Mei 2026</span>
                        <span>&middot; P: {fmt(credit.installment_amount * 0.75).replace('Rp ', '')} | B: {fmt(credit.installment_amount * 0.25).replace('Rp ', '')}</span>
                      </div>
                    </div>
