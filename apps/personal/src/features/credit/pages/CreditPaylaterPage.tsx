      ...
      <div className="card border-0 shadow-sm rounded-4">
        <div className="card-body p-4">
          <div className="text-center py-5 d-flex flex-column justify-content-center align-items-center flex-grow-1">
            <Icon icon="clock-dollar" size={32} stroke={1.5} className="text-secondary opacity-50 mb-3" />
            <div className="fw-bold text-body mb-1" style={{ fontSize: '14px' }}>Belum Ada Paylater</div>
            <div className="text-secondary mb-3" style={{ fontSize: '12px', lineHeight: '1.5' }}>Tambahkan profil Paylater Anda melalui menu "Tambah Profil" di atas.</div>
            <Button size="sm" color="primary" onClick={() => openFormForType('paylater')}>
    ...
    <div className="d-flex flex-column gap-3">
      ...
      >
        {providers.map((p) => {
          ...
          const pDaysLeft = p.credit?.due_date
            ? Math.ceil(
                (new Date(p.credit.due_date).getTime() - new Date().getTime()) /
                  (1000 * 60 * 60 * 24)
              )
            : null
              ...
              <div className="card-body p-3 d-flex flex-column justify-content-between">
                ...
                <div className="mt-2 d-flex align-items-center gap-1 text-10">
                  <Icon
                    ...
                    size={12}
                    className={
                      pDaysLeft !== null && pDaysLeft <= 5 ? 'text-danger' : 'text-success'
                    }
                  />
                  <span
                    className={
              ...
              <div className="d-flex justify-content-between gap-2 mb-3">
                <div className="col-6">
                  <div className="p-2 rounded-3 text-center" style={{ backgroundColor: '#f8fafc', border: '1px solid rgba(0,0,0,0.04)' }}>
                    <Icon icon="receipt-2" size={16} className="text-primary mb-1" />
                    <div className="text-secondary" style={{ fontSize: '10px', fontWeight: 600 }}>TRANSAKSI AKTIF</div>
                    <div className="fw-bold text-dark small">4 Cicilan</div>
                  </div>
                </div>
                <div className="col-6">
                  <div className="p-2 rounded-3 text-center" style={{ backgroundColor: '#f8fafc', border: '1px solid rgba(0,0,0,0.04)' }}>
