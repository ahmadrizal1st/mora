      ...
      <div className="card border-0 shadow-sm py-5 text-center">
        <div className="card-body">
          ...
          <p className="text-muted mb-3">
            Tambahkan profil Paylater Anda melalui menu "Tambah Profil" di atas.
          </p>
              ...
              <div className="p-3 bg-body-tertiary rounded-3 mb-4 border border-dashed">
                <div className="d-flex gap-2">
                  ...
                  <div className="small text-muted" style={{ lineHeight: '1.4' }}>
                    <span className="fw-bold text-dark">Tips AI:</span> Gunakan{' '}
                    <span className="text-primary fw-bold">Autodebet</span> untuk menghindari denda
                    keterlambatan pada tagihan berikutnya.
                  </div>
                </div>
              </div>
                      ...
                      return (
                        <tr key={i}>
                          ...
                          <td className="text-center">
                            <span className="badge bg-success-lt text-success border-0 px-2 py-1 text-10">
                              Selesai
                            </span>
                          </td>
                        </tr>
                    ...
                    return (
                      <div key={i} className="list-group-item">
                        ...
                        <div className="d-flex justify-content-between align-items-center">
                          ...
                          <span className="badge bg-success-lt text-success border-0 px-2 py-1 text-9">
                            Selesai
                          </span>
                        </div>
                      </div>
