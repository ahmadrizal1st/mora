        ...
        <div className="row g-0">
          ...
          <div className="col-6 border-end border-bottom p-3 position-relative">
            <div className="d-flex align-items-center gap-2 mb-2">
              <div className="avatar avatar-sm bg-red-lt text-red" style={{ borderRadius: '8px', width: '28px', height: '28px' }}>
                <Icon icon="credit-card" size="sm" />
              </div>
              <div className="text-muted fw-bold text-truncate" style={{ fontSize: '10px', letterSpacing: '0.05em' }}>TOTAL LIMIT</div>
            </div>
          ...
          <div className="col-6 border-bottom p-3 position-relative">
            <div className="d-flex align-items-center gap-2 mb-2">
              <div className="avatar avatar-sm bg-azure-lt text-azure" style={{ borderRadius: '8px', width: '28px', height: '28px' }}>
                <Icon icon="chart-pie" size="sm" />
              </div>
              <div className="text-muted fw-bold text-truncate" style={{ fontSize: '10px', letterSpacing: '0.05em' }}>OUTSTANDING</div>
            </div>
            <div className="fs-4 fw-bold text-danger mb-1 text-truncate" style={{ letterSpacing: '-0.5px' }}>
              {shortFmt(totalOutstanding)}
            </div>
            <div className="text-muted small text-truncate" style={{ fontSize: '11px' }}>
              <span className={`text-${utilColor} fw-bold`}>{utilizationPct.toFixed(0)}%</span> Utilisasi
            </div>
          </div>
          ...
          <div className="col-6 border-end p-3 position-relative">
            <div className="d-flex align-items-center gap-2 mb-2">
              <div className="avatar avatar-sm bg-orange-lt text-orange" style={{ borderRadius: '8px', width: '28px', height: '28px' }}>
                <Icon icon="calendar-event" size="sm" />
              </div>
              <div className="text-muted fw-bold text-truncate" style={{ fontSize: '10px', letterSpacing: '0.05em' }}>JATUH TEMPO</div>
            </div>
          ...
          <div className="col-6 p-3 position-relative">
            <div className="d-flex align-items-center gap-2 mb-2">
              <div className="avatar avatar-sm bg-blue-lt text-blue" style={{ borderRadius: '8px', width: '28px', height: '28px' }}>
                <Icon icon="award" size="sm" />
              </div>
              <div className="text-muted fw-bold text-truncate" style={{ fontSize: '10px', letterSpacing: '0.05em' }}>CREDIT SCORE</div>
            </div>
            <div className="fs-4 fw-bold text-success mb-1 text-truncate d-flex align-items-baseline gap-2" style={{ letterSpacing: '-0.5px' }}>
              {creditScore}
              <span className="small text-success fw-bold" style={{ fontSize: '11px' }}>↑ +{scoreTrend}</span>
            </div>
            <div className="text-muted small text-truncate" style={{ fontSize: '11px' }}>
              SLIK/OJK
            </div>
