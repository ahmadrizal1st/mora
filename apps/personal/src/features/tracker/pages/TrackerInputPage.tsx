...
} from '@/features/transaction/components/TransactionForm'
import {
    ...
    <BaseLayout
      ...
      pageDescription={
        id
          ...
          : 'Lengkapi detail transaksi di bawah ini secara manual.'
      }
    >
      <div className="row justify-content-center">
        <div className="col-12 col-md-10 col-lg-9 col-xl-8">
          {txError && (
            <div className="mb-3">
              <ErrorAlert message="Gagal Memuat Data: Data transaksi tidak ditemukan atau terjadi kesalahan." />
            </div>
          )}

          <div className="card shadow-sm">
            <div className="card-header">
              <h3 className="card-title">{id ? 'Transaction Details' : 'New Transaction'}</h3>
            </div>
