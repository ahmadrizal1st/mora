              ...
              <div className="card-body">
                {activeTab === 'account' && (
                  <>
                    ...
                    <p className="card-subtitle">
                      Kontak ini akan ditampilkan secara publik kepada pihak lain, pilihlah dengan
                      bijak.
                    </p>
                ...
                {activeTab === 'privacy' && (
                  <>
                    ...
                    <p className="card-subtitle">
                      Anda dapat menetapkan kata sandi permanen jika tidak ingin menggunakan kode
                      masuk sementara.
                    </p>
                    <div className="mb-4">
                    ...
                    <div className="mb-4">
                      <label className="form-check form-check-single form-switch form-switch-lg">
                        ...
                        <span className="form-check-label form-check-label-off">
                          Anda saat ini tidak terlihat (privat)
                        </span>
                      </label>
                    </div>
                      ...
                      <div className="list-group-item px-0">
                        <div className="row align-items-center">
                          ...
                          <div className="col text-truncate">
                            ...
                            <div className="text-secondary text-truncate mt-n1">
                              Terakhir sinkronisasi: 5 jam lalu
                            </div>
                          </div>
                          <div className="col-auto">
                            <Button text="Putuskan" color="danger" ghost size="sm" />
                  ...
                  <>
                    ...
                    <div className="card bg-primary-lt mb-4">
                      <div className="card-body">
                        ...
                        <p>
                          Nikmati akses tanpa batas ke semua fitur premium, termasuk analisis
                          lanjutan dan prioritas dukungan.
                        </p>
