            ...
            <div className="col-12 d-md-none border-bottom p-2 bg-light">
              <div className="d-flex align-items-center justify-content-between gap-2">
                <div className="btn-group shadow-sm">
                  <button 
                    className={clsx("btn btn-white px-3 d-flex align-items-center justify-content-center", filter === 'all' && "active")} 
                    style={{ borderTopLeftRadius: '8px', borderBottomLeftRadius: '8px', height: '36px', minWidth: '60px' }}
                    onClick={() => setFilter('all')}
                  >
                    All
                  </button>
                  <button 
                    className={clsx("btn btn-white px-3 d-flex align-items-center justify-content-center", filter === 'unread' && "active")} 
                    style={{ borderTopRightRadius: '8px', borderBottomRightRadius: '8px', height: '36px', minWidth: '60px' }}
                ...
                <div className="d-flex align-items-center gap-2">
                  <div className="btn-group shadow-sm">
                    <button 
                      className={clsx("btn btn-icon btn-white p-0 d-flex align-items-center justify-content-center", filter === 'archive' && "active")} 
                      style={{ borderTopLeftRadius: '8px', borderBottomLeftRadius: '8px', width: '36px', height: '36px' }}
                      title="Archive"
                    ...
                    <button 
                      className={clsx("btn btn-icon btn-white p-0 d-flex align-items-center justify-content-center", filter === 'starred' && "active")} 
                      style={{ borderTopRightRadius: '8px', borderBottomRightRadius: '8px', width: '36px', height: '36px' }}
                      title="Starred"
                ...
                <div className="list-group list-group-transparent mx-0">
                  {labels.map((item) => (
                    <a
                      ...
                      className={clsx(
                        "list-group-item list-group-item-action d-flex align-items-center border-0",
                        filter.toLowerCase() === item.label.toLowerCase() ? "active fw-bold" : "text-secondary"
                      )}
                      style={{ outline: 'none' }}
                      onClick={(e) => {
                        e.preventDefault()
