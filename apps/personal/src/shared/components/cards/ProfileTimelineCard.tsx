        ...
        <div className="input-group">
          ...
          <button className="btn btn-icon">
            ...
            >
              ...
              <path d="M15 8h.01m-6.01 0h.01m2.99 9v-3.5a3.5 3.5 0 0 1 7 0v3.5m-7 -9.5h14" />
            </svg>
          </button>
        </div>
      </div>
          ...
          <li key={i} className="list-group-item py-4">
            <div className="d-flex">
              <span className="avatar me-3">
                {t.avatarSrc ? <img src={t.avatarSrc} alt={t.name} /> : t.name.charAt(0)}
              </span>
                  ...
                  <ul className="list-unstyled">
                    {t.replies.map((r, j) => (
                      <li key={j} className="d-flex mt-4">
                        <span className="avatar me-3">
                          {r.avatarSrc ? <img src={r.avatarSrc} alt={r.name} /> : r.name.charAt(0)}
                        </span>
                        <div className="flex-fill">
