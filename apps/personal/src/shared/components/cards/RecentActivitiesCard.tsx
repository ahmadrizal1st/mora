        ...
        <div className="d-flex flex-column justify-content-between flex-grow-1">
          <div>
            ...
            <div className="d-flex align-items-center mb-3">
              <div
                className="bg-primary-lt text-primary rounded-circle d-flex align-items-center justify-content-center me-3 flex-shrink-0"
                style={{ width: '32px', height: '32px' }}
              >
                <Icon icon="chart-arrows" size="sm" />
              </div>
              <div>
                <div className="text-muted small fw-medium mb-1" style={{ fontSize: '0.65rem' }}>
                  11:45 AM
                </div>
