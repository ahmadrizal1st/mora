...
const holdings = [
  ...
  { name: 'Gopay', ticker: 'E-Wallet', value: 'Rp 3.550.000', pct: '+1.2%', positive: true, icon: 'wallet', bg: '#00d084' },
];
                ...
                <tr key={h.name} className={index < holdings.length - 1 ? 'border-bottom' : ''}>
                  <td className="w-1 py-2 ps-4">
                    <div
                      ...
                      style={{ width: '32px', height: '32px', borderRadius: '8px', background: h.bg, flexShrink: 0 }}
                    >
