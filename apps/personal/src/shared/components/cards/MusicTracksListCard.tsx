        ...
        {tracks.map((track, i) => (
          <div key={i} className="list-group-item">
            <div className="row g-2 align-items-center">
              ...
              <div className="col-auto">
                {track.albumArt ? (
                  ...
                  <div
                    ...
                    style={{ width: 40, height: 40, background: '#e0e0e0' }}
                  >
                    ♪
                  </div>
                )}
              ...
              <div className="col">
                <div>{track.name}</div>
                {track.artists && <div className="text-secondary">{track.artists.join(', ')}</div>}
              </div>
              {track.duration && <div className="col-auto text-secondary">{track.duration}</div>}
              <div className="col-auto">
                <button
