...
export function VisualStatCard({
  ...
  const chartData = useMemo(() => {
    const basePattern = [
      10, 10, 12, 16, 13, 8, 8, 10, 26, 12, 10, 10, 12, 22, 19, 15, 12, 12, 10, 8, 16, 65, 35, 20,
      18, 22, 18, 8, 18, 16, 14, 25, 20, 15, 8, 12, 15, 15, 25, 35,
    ]
        ...
        <div className="p-3 pb-2 z-1">
          <div className="d-flex justify-content-between align-items-center mb-3">
            <div className="d-flex align-items-center gap-2">
              <div
                className={`bg-${isPositive ? 'primary' : 'secondary'}-lt text-${isPositive ? 'primary' : 'secondary'} rounded-circle d-flex align-items-center justify-content-center`}
          ...
          <div className="d-flex justify-content-between align-items-end mt-1">
            ...
            <div className="text-muted small">
              <span className={isPositive ? 'text-primary fw-bold' : 'text-danger fw-bold'}>
                {trendAbsolute}
              </span>{' '}
              than last week
            </div>
