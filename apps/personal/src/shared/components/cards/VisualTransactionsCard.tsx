          ...
          <table className="table table-vcenter table-borderless text-nowrap mb-0">
            <thead>
              <tr className="border-bottom">
                <th className="text-muted small fw-medium">
                  Keterangan <Icon icon="selector" size="xxs" className="ms-1" />
                </th>
                <th className="text-muted small fw-medium">
                  Kategori <Icon icon="selector" size="xxs" className="ms-1" />
                </th>
                <th className="text-muted small fw-medium">
                  Tanggal <Icon icon="selector" size="xxs" className="ms-1" />
                </th>
                <th className="text-muted small fw-medium">
                  Jumlah <Icon icon="selector" size="xxs" className="ms-1" />
                </th>
                <th className="text-muted small fw-medium">
                  Status <Icon icon="selector" size="xxs" className="ms-1" />
                </th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-bottom">
                ...
                <td className="py-2">
                  <div className="d-flex align-items-center gap-2">
                    <div
                      className="bg-primary text-white rounded-1 px-1 fw-bold align-items-center justify-content-center d-flex"
                      style={{ fontSize: '0.6rem', width: '32px', height: '20px' }}
                    >
                      BNI
                    </div>
              ...
              <tr>
                ...
                <td className="py-2">
                  <span className="badge bg-primary-lt text-primary rounded-pill px-2">
                    Terjadwal
                  </span>
                </td>
              </tr>
