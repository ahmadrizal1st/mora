        ...
        <div className="row items-center text-center g-lg-10">
          <div className="col-md-6 col-lg">
            ...
            <p className="text-secondary">
              Our email templates are fully responsive, so you can be sure they will look great on
          ...
          <div className="col-md-6 col-lg">
            ...
            <p className="text-secondary">
              Tested across 90+ email clients and devices, Tabler emails will help you make your
              email communication professional and reliable.
            </p>
          </div>
          <div className="col-md-6 col-lg">
            ...
            <p className="text-secondary">
              Draw recipients' attention with beautiful, minimal email designs based on Bootstrap
