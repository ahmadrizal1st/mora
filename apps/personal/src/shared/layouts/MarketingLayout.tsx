            ...
            <div className="row align-items-center flex-row-reverse">
              <div className="col-lg-auto ms-lg-auto">
                <ul className="list-inline list-inline-dots mb-0">
                  <li className="list-inline-item"><Link to="/" className="link-secondary">Documentation</Link></li>
                  <li className="list-inline-item"><Link to="/" className="link-secondary">License</Link></li>
              ...
              <div className="col-12 col-lg-auto mt-3 mt-lg-0">
                <ul className="list-inline list-inline-dots mb-0">
                  <li className="list-inline-item">
                    ...
                    <Link to="/" className="link-secondary ms-1">Mora</Link>.
                    All rights reserved.
                  </li>
                </ul>
              </div>
